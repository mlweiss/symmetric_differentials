...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_22 = Integer(22); _sage_const_23 = Integer(23)
import sys
        ...
        for monomial in map(mul, zip(polynomial.coefficients(), polynomial.monomials())):
            if monomial.degree(u) < monomial.degree(du):
                if not basis[monomial.lm()]:
                    ...
                    count += _sage_const_1 
                matrix[index][basis[monomial.lm()] - _sage_const_1 ] = monomial.lc()
    print matrix
...
test_sums(_sage_const_22 , _sage_const_23 )
